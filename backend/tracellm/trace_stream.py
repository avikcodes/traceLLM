...
from tracellm.themes import current_theme, primary, secondary, info
...
class TraceStream:
    ...
    def _render(self) -> Panel:
        ...
        event_table.add_column(style=theme.secondary, width=10)
        event_table.add_column(style=theme.info)
        ...
        summary.add_column(style=theme.secondary)
        summary.add_column(style=theme.primary)
        ...
        body.add_column()
        body.add_row(Text("Event Stream", style=theme.primary))
